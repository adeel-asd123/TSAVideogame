...
class MyApp(ShowBase):
    ...
    def createwalls(self):
        ...
        self.wall_collision_node.addSolid(CollisionBox(Point3(8.5, -33, 8), 4.5, 1, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-10, -33, 8), 4.5, 1, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-17.5, -30, 8), 1, 4, 4))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-36, -34.25, 8), 6, 3.25, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-38.75, -25.5 , 8), 4, 1.25, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-40, -12 , 8), 2, 4, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-28, -11 , 8), 1, 1, 1))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-18, -11 , 8), 1, 1, 1))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-34.5, -41.4 , 8), 1, 3.6, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-42, -54 , 8), 1.5, 1.5, 1))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-25.75, -40, 8), .75, .5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-22.5, -40, 8), .75, .5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-25.75, -46, 8), .75, .5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-22.5, -46, 8), .75, .5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-24.25, -42.75, 8), 3.5, 1.5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-18, -58, 8), 1, 5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-42, -59, 8), 1, 3, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-11, -37, 8), 5, 1, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(12, -37, 8), 1, 1.5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(11.25, -61.5, 8), 3.25, 1.5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-13.5, -61, 8), 1, 1.5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-1, -55, 8), 4.75, 2, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(6, -49, 8), 2, 1.5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-7, -49, 8), 2, 1.5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-.8, -49.25, 8), 2, 1.5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(-.75, -43, 8), 4.5, 1.75, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(15.8, -59.5, 8), .8, 2.95, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(23, -58.7, 8), 2.3, 4, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(39, -58.5, 8), 1.6, 4.2, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(39, -40.4, 8), 1.6, 13.155, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(17.75, -36, 8), 2.95, 1.5, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(25, -29.5, 8), 1.3, 2.95, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(24.5, -21, 8), .7, 1, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(26.1, -12.75, 8), 2.8, 1.4, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(24.5, -21, 8), .7, 1, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(39.5, -10, 8), 1, 1, .75))
        self.wall_collision_node.addSolid(CollisionBox(Point3(39.5, -20.4, 8), 1, 2.5, .75))
